window.BCR=window.BCR||{};window.BCR.upd={
 "updates": [
  ...
  },
  {
   ...
   "competitorId": "selecta",
   "category": "strategy",
   "headline": "Selecta splits its coffee proposition three ways: office, hospitality and hotel",
   "detail": "A new commercial coffee machines page now sits alongside the office range, written for cafes, restaurants and hotels, with copy on venues selling 500+ drinks a day and on barista-led versus semi-automatic service. It names Evoca, Coffetek, Gaggia Milano, Franke, Astoria and Schaerer as partners and states outright that Selecta does not offer off-the-shelf pricing. The hotel sector page that was hidden behind noindex on 8 September is now public, indexed and linked from the new page, claiming over 3,000 hotels served. None of the new pages carries a publication date, so the timing of the rebuild is confirmed only as 'since 17 September'.",
   "bridgeResponse": "The segmentation is sound, and it is the same reading of the market we have. The gap it exposes is the one Selecta keeps choosing: three audiences, nine new pages and still no price anywhere. Where we meet them in hotels, lead with the published numbers — beans £10–£20/kg, callouts £185, service contracts £500–£2,000 a year — and with Four Seasons on the reference list.",
  ...
  },
  {
   ...
   "competitorId": "selecta",
   "category": "launch",
   "headline": "Selecta's office machine range roughly doubles, and a Starbucks-branded Franke enters it",
   "detail": "The office coffee machines page has gone from nine models to seventeen. Ten are new against our record: Schaerer Skye, Coffetek Vitro X4, Vitro Series 3, Vitro S2, Vitro X1, Vitro X3, Coffetek Neo, Crane Infinity, Crane Cali and Franke A600. The A600 is tagged 'Starbucks®' rather than 'Coffee & Hot Beverages', the only machine on the page tagged that way, and a supporting block on the hot beverages hub is built around Starbucks, Change Please and Pelican Rouge.",
   "bridgeResponse": "Brand-badged hardware is Selecta's answer to the question of why a workplace should buy from a vending operator. Ours is different and checkable: we roast the coffee, we place and maintain the machine, and our engineers are our own. Against a Starbucks-badged A600 the argument is provenance and cost per cup, not logo recall.",
  ...
  },
  {
   ...
   "competitorId": "selecta",
   "category": "strategy",
   "headline": "Astoria traditional machines move out of Selecta's office range and into hospitality",
   "detail": "The Astoria Plus 4U Advantage and Astoria C600 no longer appear among the seventeen models on the office coffee machines page. Both are still on the hot beverages hub and are the only two machines on the new commercial page, so this is a repositioning rather than a withdrawal: traditional espresso is now framed as a hospitality product and bean-to-cup as the office product.",
   "bridgeResponse": "Sensible tidying on their side, and it narrows the office conversation to automation. It also concedes the ground where a roaster wins — traditional espresso, barista training, dialling in. That is where our SCA training and our Sanremo line do the talking.",
   "source": "https://www.selecta.com/uk/en/coffee-and-hot-beverages/office-coffee-machines",
   "severity": "info"
  },
  {
   ...
   "competitorId": "selecta",
   "category": "content",
   "headline": "Selecta's rebuilt UK pages leak Irish URLs on enquiry routes",
   "detail": "Two calls to action on the UK office coffee page — 'Contact us for a tailored proposal' and 'Read more about our technical service' — resolve to /ie/en/ Irish URLs, and the hotels tile on the new commercial page links to an Irish campaign page. The UK pages appear to have been cloned from the Irish build without the locale corrected. Separately, the hot beverages hub still carries a 'Refurbished machines' block whose 'Find out more' has no working link, while the refurbished URL itself continues to redirect to the vending range.",
   "bridgeResponse": "Worth knowing rather than worth repeating to a customer. The useful version is the underlying point: a group operation ships pages faster than it can localise them, and the buyer ends up on the wrong enquiry form. Ours goes to a named person in Cardiff.",
   "source": "https://www.selecta.com/uk/en/coffee-and-hot-beverages/office-coffee-machines",
   "severity": "info"
  },
  {
   ...
   "competitorId": "matthew-algie",
   "category": "campaign",
   "headline": "Matthew Algie runs a 'first month free' acquisition offer into Nisa convenience stores",
   "detail": "A Nisa x Smokin' Bean offer is live from 1 September to 30 November 2026, open to the first 50 eligible Nisa retailers in Great Britain who are new customers with no existing Smokin' Bean solution. The retailer keeps 100 per cent of coffee sales revenue during the free month, with claw-back on early termination; minimum spec is 1m², a 13amp supply and water. It is claimed by QR code on a printed flyer, so distribution is through depots and retailer channels rather than the website.",
   "bridgeResponse": "A capped, dated, channel-specific offer is a better piece of commercial work than anything else in the tracked set this week. The lesson for us is the mechanic, not the discount: a named channel, a hard cap, a published end date. We do not need to match free — our forecourt and convenience proposition already publishes what the coffee and the service cost.",
  ...
  },
  {
   ...
   "competitorId": "matthew-algie",
   "category": "launch",
   "headline": "A fourth, self-branded Matthew Algie coffee range appears in the main navigation",
   "detail": "Alongside Peak & Wild, Piacetto and Smokin' Bean there is now a range carrying the Matthew Algie name itself, with three blends listed — Tierra Verde, Crema and Tiki, the last triple certified Fairtrade, Organic and Rainforest Alliance. The page's meta description references 'six best-selling blends' against three shown, so it looks part-populated. Page last modified 27 August 2026, meaning this may have been live before our previous pass rather than launched since.",
   "bridgeResponse": "Triple certification on a house blend is the direct comparator for the Roots Collection, which is certified Fairtrade, Organic and Rainforest Alliance and priced in public. Where this comes up, put the two side by side on certification and on price, and let the enquiry-only wall do the rest.",
  ...
  },
  {
   ...
   "competitorId": "matthew-algie",
   "category": "content",
   "headline": "Matthew Algie puts a machine selector and a one-hour callback promise in front of the range",
   "detail": "A 'Machine Finder' tool is live — a three-step qualifier ending in a contact form that promises a call back within an hour during office hours. The machine estate behind it is wider than we had recorded: twenty machines across traditional espresso, grinders (Mazzer Super Jolly V Up, Eureka Atom Touch 65, Helios 75, Mythos, Bunn GVH-3A) and filter and beverage (Bravilor Bonamat B10 HW, ISO, TH, Bolero 11, Bolero 43, Bunn ICBA Platinum, Bunn Thermofresh), plus three bean-to-cup formats: Coffee Bar, Coffee Point and Cafe Destination, the last added 25 June 2026.",
   "bridgeResponse": "The one-hour callback is a service promise made at the top of the funnel, and it is measurable. Ours should be too. On the estate itself, breadth of third-party hardware is not the differentiator it looks like — the question a buyer should ask is who maintains it, and the answer there is a subcontracted network.",
  ...
  },
  {
   ...
   "competitorId": "matthew-algie",
   "category": "strategy",
   "headline": "Peak & Wild's 2026 charity hook is named as John Muir Trust restoration at Thirlmere",
   "detail": "The Peak & Wild page now carries a specific 2026 project — nature restoration at Thirlmere in the Lake District with the John Muir Trust — and offers customers a free point-of-sale suite made from recycled coffee grounds. The journal remains dormant, the sitemap contains no 2026 article URLs, and the footer is still stamped 2025, so the purpose story is being carried by product pages rather than by publishing.",
   "bridgeResponse": "Free branded point of sale made from recycled grounds is a good, cheap hook and we should note it. The broader read is unchanged: the marketing effort is going into the room — Caffè Culture on 29–30 September — and into print, not into the website.",
  ...
  },
  {
   ...
   "competitorId": "ucc",
   "category": "pricing",
   "headline": "Dr Coffee M12 Plus metadata price corrected down to £2,999.99",
   "detail": "The product page metadata now reads og:price:amount 2999.99, against £3,065.99 recorded on 25 August, so the metadata and the collection grid finally agree. The machine is still out of stock and the product page body still shows no price at all, only a callback form. The 41x60x65cm spec-sheet contradiction logged on 17 September could not be reproduced this pass — the callback is now an inline modal carrying no dimensions and no separate callback page could be found, so treat that one as unverified rather than resolved.",
   "bridgeResponse": "Four weeks of a flagship machine that is out of stock, priced in three places and priced in none of them on the page itself. We publish one number, hold it, and the machine is in the warehouse in Cardiff.",
  ...
  },
  {
   ...
   "competitorId": "ucc",
   "category": "strategy",
   "headline": "Three more UCC lines go out of stock even as the Ueshima restock holds",
   "detail": "Grand Café Fair Trade Beans 10 x 500g (£83.69) is now out of stock, as are Lyons No.4 R&G 7 x 150g (£17.96) and the Bunn 2.5ltr Manual Airpot Flask (£56.00). The Ueshima House Blend and Fuji Mountain restocks recorded on 17 September have held, with no out-of-stock flags anywhere in the Ueshima range, and the Lyons core lines — Go-Joe, Perkadilly, Decaf Dreams — remain available. The Grand Café temporary packaging notice is still running with no end date.",
   "bridgeResponse": "The core has come back but the supply problem has moved sideways rather than cleared, and it is now four months old across Grand Café, Lyons and Ueshima in turn. Continuity of supply is the argument, and it is the one a contract caterer actually feels. We roast to order in Cardiff and the lead time is ours to control.",
  ...
  },
  {
   ...
   "competitorId": "ucc",
   "category": "campaign",
   "headline": "Ueshima Matcha Syrup gets a price — £27.50 a litre on a sub-50p-per-serving claim",
   "detail": "The matcha syrup banner logged on 17 September now has a figure behind it: £27.50 for a 1L bottle, in stock, claiming 60-plus servings and 'under 50p per serving'. It leads the shop homepage carousel ahead of the Dr Coffee machine banner. Note the line does not appear in the Ueshima brand-filtered collection despite loading fine at its own URL, which looks like a taxonomy fault rather than a delisting.",
   "bridgeResponse": "Cost per serving is the right way to sell a syrup into a workplace and we should be using it too. Matcha is now on the shelf at UCC, Clifton and in Liquidline's content — three of seven tracked competitors. If we are not putting a priced matcha proposition in front of BridgeConnect customers this quarter we are late.",
  ...
  },
  {
   ...
   "competitorId": "ucc",
   "category": "content",
   "headline": "The M12 Plus listing gains an FAQ block that steers buyers onto Ueshima beans",
   "detail": "A ten-question FAQ now sits on the Dr Coffee M12 Plus page, covering drink range, fresh milk, a 100 cups a day throughput figure, cleaning and after-sales. The bean question explicitly points buyers to Ueshima beans, tying machine placement to coffee pull-through on the product page itself.",
   "bridgeResponse": "That is the full-stack argument, made by a distributor that does not own the roastery. We do own it, and we sell the machine, the water treatment and the engineer alongside it. The counter is not that they are wrong to link the two — it is that we can put a single accountable price on the whole of it.",
   "source": "https://www.ucc-coffee-direct.co.uk/collections/coffee-machines/products/dr-coffee-m12-plus-automatic-coffee-machine",
   "severity": "watch"
  },
  {
   ...
   "category": "pricing",
   "headline": "Seven more Liquidline weekly lease rates on the record, and a Q3 in the own-brand ladder",
   "detail": "Rates verified on the machine grid: Franke SB1200 Fresh Milk £101.50/week (top of the published ladder), Schaerer Coffee Soul 10 Fresh Milk £92.00, Schaerer Coffee Skye £59.00, Liquidline Q3 Powdered Milk £33.00, La Spaziale S21 2 Group Takeaway Compact £28.00, Coffetek Vitro S5 Powdered Milk £26.50 and Vitro S2 Instant £23.00. The Q3 means the own-brand ladder reads K1, K2, Q1, Q2, Q3. Caveat: the ladder was previously logged in aggregate at £14.00–£101.50, so these are rates newly verified rather than confirmed increases. Only page one of the three-page grid was read this pass.",
   "bridgeResponse": "Their ladder is now five own-brand tiers deep and priced by weekly rate rather than by specification. That is the shape our Apex, Pulse, Core, Aero and Axis range has to answer, and it argues for publishing a rate against each tier rather than a spec sheet. Note the Aero has no milk fridge included — it must be in the quote every time, or we lose the comparison on a number we chose not to state.",
  ...
  },
  {
   ...
   "competitorId": "liquidline",
   "category": "campaign",
   "headline": "Liquidline goes quiet again six days after the homepage refresh",
   "detail": "The homepage modified timestamp is still 15 September and the hero is still the Schaerer Soul 12 Moor Park customer story. The news index holds 102 items with nothing newer than 28 July. No offer has appeared anywhere on the site. The Trustpilot interstitial tiles in the machine grid use an August 2026 asset and now claim over 2,000 reviews, a 92 per cent five-star rate and a 4.8 rating.",
   "bridgeResponse": "One hero in eight weeks and no offer on the site. The proof tiles are doing the persuading instead, and at 2,000 reviews they do it well. Review volume is the gap we should be closing rather than matching their silence with our own.",
  ...
  },
  {
   ...
   "competitorId": "union",
   "category": "pricing",
   "headline": "SEPTEMBER20 disappears from the Union site with no end date and nothing behind it",
   "detail": "The 20 per cent sitewide code, which was the full homepage hero on 10 September and still live on 17 September, is gone. No reference to it survives on the homepage, the All Our Coffees collection, the New Arrivals collection or the product pages checked. The hero is now a generic brand panel and the announcement bar carries delivery thresholds only. The code ran roughly thirteen days and ended without notice.",
   "bridgeResponse": "A blanket discount that appears without a reason and vanishes without an end date trains customers to wait for the next one. Our position is the opposite and it is the easier one to defend: the price is published, it is the same on Monday as on Friday, and it is the same for a two-site operator as for a fifty-site one.",
  ...
  },
  {
   ...
   "competitorId": "union",
   "category": "strategy",
   "headline": "Summer Blend sells out in every format with no autumn blend behind it",
   "detail": "The Summer Blend page is still live at £10.75/200g and £43.00/1kg, but all five variants — 200g wholebean, cafetiere, filter and espresso, plus the 1kg — show sold out, and the product meta reads out of stock. Nothing seasonal has replaced it: no autumn blend on the homepage, in navigation or in new arrivals. The blog has not moved since October 2025. With SEPTEMBER20 also gone, Union's promotional shop window is now bare apart from standing delivery thresholds.",
   "bridgeResponse": "Union has run out of summer in late September with nothing behind it and no discount left running. That is an opening on seasonal wholesale accounts through October. Our seasonal work should be on the calendar and in front of customers before the season turns, not after.",
  ...
  },
  {
   ...
   "competitorId": "union",
   "category": "launch",
   "headline": "José Fernando, Guatemala joins the Limited Parcel rail at £12.35",
   "detail": "A new Limited Parcel microlot leads new arrivals at £12.35/200g and £49.50/1kg — Finca La Montaña, Huehuetenango, 1,800–2,050 masl, washed, quality score 85.25, notes of red apple, roasted hazelnut and dried apricot. It sits ahead of Miguel Pérez and João Hamilton on the rail and is priced below João Hamilton's £55.50/kg. Separately, delivery terms are now set out on product pages as three tiers — free on any 1kg bag, free over £30 by Royal Mail, free over £45 by DPD — while the New Arrivals meta description still says £25.",
   "bridgeResponse": "£49.50/kg on a scored microlot is the top of the speciality retail rail, not a wholesale number, and it is roughly two and a half times our published ceiling. Useful for anchoring: we publish £10–£20/kg for wholesale beans and will show the cupping score alongside it.",
  ...
  },
  {
   ...
   "competitorId": "origin",
   "category": "strategy",
   "headline": "The Mierisch anniversary range clears entirely, taking Origin's ceiling from £20.70 to £15.75",
   "detail": "The speciality coffee collection is down to fifteen products and now contains no La Huella Natural (£17.70), no La Huella Dwarf Gesha (£16.20) and no Chilamate (£13.75), joining Mariposa and El Paseo which went earlier. The whole 15-year Mierisch anniversary campaign is off the site inside three weeks of launch. Umalila at £15.75/250g is now the most expensive bagged coffee on the rail, a fall of roughly a quarter from the £20.70 ceiling recorded on 3 September. The RTD Iced Black Coffee 6-pack is flagged 'Coming Soon' at £18.00, which reads as a stock gap rather than a delisting.",
   "bridgeResponse": "A flagship anniversary range that lasted under a month tells you the volumes were tiny and the campaign was a storefront event rather than a supply commitment. It is the structural difference between a weekly-drop retail roaster and a wholesale supplier: we are asked to hold a blend for three years, not three weeks.",
  ...
  },
  {
   ...
   "competitorId": "origin",
   "category": "launch",
   "headline": "Arsosala and a sail-shipped Caxambu arrive as the rail refills",
   "detail": "Arsosala (Uraga, Guji, Ethiopia) is on the rail at £14.70/250g — washed heirloom, 1,800–1,900 masl, 1,200 smallholders, FOB $4.92/lb at plus 173 per cent on the Fairtrade minimum, cup score 88, relationship dated 2026. Caxambu is listed from £12.95 and badged 'Shipped by Sail'. The Caxambu product pages returned empty bodies on two attempts, so variant pricing is unconfirmed.",
   "bridgeResponse": "Origin keeps publishing FOB, differential over the Fairtrade minimum and cup score on every lot. That is the benchmark for transparency in this set and we should be honest that they are ahead of us on it. Roots is certified Fairtrade, Organic and Rainforest Alliance; putting a score and a farmgate figure next to the certification would close the gap.",
  ...
  },
  {
   ...
   "competitorId": "origin",
   "category": "strategy",
   "headline": "'Shipped by Sail' becomes a named sourcing programme in Origin's main navigation",
   "detail": "Sail freight has been promoted from a lot-level note to a navigation item and a homepage feature panel headed 'Setting a new standard for responsible sourcing', with Caxambu as the first coffee carrying the badge. A second navigation panel promotes the new cold brew brewery. The app is now pushed in navigation with the rewards mechanics published on product pages: 15 points per £1 on subscriptions against 10 on one-off orders, 25 per cent off the first three subscription orders then a fixed 10 per cent, and free gifts at orders four, seven and ten.",
   "bridgeResponse": "Sail freight is a strong retail story and a weak wholesale one — no contract caterer will accept the lead times. Where it will bite is in tender sustainability sections. Our answer there is certification we can evidence across the Roots Collection plus the carbon we take out by roasting and delivering from one site.",
  ...
  },
  {
   ...
   "competitorId": "origin",
   "category": "content",
   "headline": "Fellow giveaway winner still unpublished, nineteen days past the announced date",
   "detail": "The competition landing page is still live and still reads 'Competition closes 31/08/26 at 23:59. Winner announced 02/09/26', with Resolute and Los Altos as the qualifying products. No announcement exists on the journal, which itself has not moved since 30 July 2026. This is at least the fifth consecutive pass with the same unresolved thread.",
   "bridgeResponse": "Small, but it is a published promise on a live page that has been missed for three weeks. Worth holding ourselves to the opposite standard on every dated commitment we make, including service response times.",
  ...
  },
  {
   ...
   "category": "launch",
   "headline": "Blend Friends: Clifton co-roasts a limited blend with Bristol neighbour Oddkin at £15.00",
   "detail": "Episode 11 of the Blend Friends project pairs Clifton with Oddkin, a small independent Bristol roastery, on a jointly built blend released in a very limited batch — £15.00/250g, 1kg also listed, wholebean only, omni roast. It combines a washed anaerobic Colombia Las Flores Caturra Chiroso (Acevedo, Huila, 1,750–1,950 masl) with a natural Honduras from Finca El Mantazano, La Paz; notes of purple grape, forest fruits and elderflower. At £15.00 it is Clifton's most expensive 250g bag, £1.00 above Cadence and Las Flores. Product images carry a CDN timestamp of roughly 20 September.",
   "bridgeResponse": "Clifton is the only tracked roaster launching anything this week, and it has now run two releases in five days. Collaborating with a smaller local roaster rather than competing with it is a cheap, repeatable way to buy relevance in a city. Worth a note for how we handle Cardiff independents.",
  ...
  },
  {
   ...
   "competitorId": "clifton",
   "category": "content",
   "headline": "Clifton puts B Corp certification and an SCA training campus claim on the homepage",
   "detail": "The homepage now carries a B Corp panel and footer badge stating certification since 2023, and an SCA Training panel claiming Clifton runs the UK's only SCA Premier Training Campus outside London. A Home Barista Course has its own homepage panel. The coffee grid has also gained a row of curated entry points: Best Sellers, New Arrivals, Great for Filter, Great for Espresso, Great with Milk, Complex & Funky.",
   "bridgeResponse": "The SCA claim is the one that matters, because training is a real part of our proposition too. It is a regional claim, not a national one, and we should check it rather than repeat it. On B Corp: it is a credential we do not hold and cannot counter with words — either we pursue it or we compete on the certifications the Roots Collection already carries.",
  ...
  },
  {
   ...
   "competitorId": "clifton",
   "category": "strategy",
   "headline": "Sidra leaves the Unparalleled Series as the anniversary lot takes the top slot",
   "detail": "The Unparalleled Series is now four products: 25th Anniversary Colombia £21.00/110g, Pink Bourbon (Sebastian Ramirez) £20.75/120g, Gesha (Wilton Benitez) £20.00/120g and Ombligon £15.00/120g. Sidra, recorded in the series on 12 June, is absent from both the series collection and the full coffee collection. Guatemala – La Esperanza (£14.00) is listed but sold out. Clifton is also merchandising beyond coffee — Dark Hot Chocolate 500g now sits alongside tea and matcha, and the £8.99 storage tin is a standalone SKU as well as a subscription gift.",
   "bridgeResponse": "Clifton is rotating the top of its range rather than growing it, which keeps the £20-plus tier scarce and the £11–£14 rail stable. That £11–£14 rail is where wholesale conversations actually happen and it has not moved in three months. Hot chocolate alongside coffee is also the third competitor this year to widen into adjacent hot drinks — relevant to the US hot chocolate work.",
